...
public class SkillEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        skill.cost = EditorGUILayout.IntField("Co�t", skill.cost);

        // Liste des comp�tences requises
        SerializedProperty previousSkillsProperty = serializedObject.FindProperty("previousSkills");
        EditorGUILayout.PropertyField(previousSkillsProperty, new GUIContent("Comp�tences Pr�c�dentes"), true);
        ...
        {
            skill.statAdd = (STATS_ADD)EditorGUILayout.EnumPopup("Statistique � Ajouter", skill.statAdd);
        ...
        // Si d'autres modifications ont �t� effectu�es, marque l'objet comme modifi�
        if (GUI.changed)
        {
