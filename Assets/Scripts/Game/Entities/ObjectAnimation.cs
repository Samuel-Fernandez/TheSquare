...
public class ObjectAnimation : MonoBehaviour
{
    ...
    // M�thode principale pour jouer l'animation
    ...
    // M�thode IEnumerator pour jouer l'animation
    ...
    private IEnumerator AnimateSprite(SpriteAnimation animation, bool lastImageStay, bool playInReverse, float animationSpeed)
    {
        ...
        if (spriteCount == 0) yield break; // S'assurer qu'il y a des sprites � animer
        ...
        {
            // Red�marrer l'animation si elle ne doit pas rester sur la derni�re image
            if (currentAnimationCoroutine != null)
            {
                StopCoroutine(currentAnimationCoroutine);
            }
    ...
    public void StopAllAnimations()
    {
        ...
        // Remettre le sprite initial stock�
    ...
    {
        // R�initialiser le sprite et stopper les animations lors de l'activation
        if (spriteRenderer != null)
        {
            spriteRenderer.sprite = initialSprite;
        }
