...
public class MineralBehiavor : MonoBehaviour
{
    ...
    void Update()
    {
        if (type == MineralType.SQUAREBLOCK)
        {
            ...
            float t = (elapsedTime % cycleDuration) / cycleDuration; // Valeur normalis�e entre 0 et 1
    ...
    {
        // Interpolation lin�aire entre les couleurs de l'arc-en-ciel
        t *= 6f; // �chelle pour passer par 6 couleurs
