...
public class Item : ScriptableObject
{
    ...
    // Vol vie          : 10 % de chances de voler 20 % des d�g�ts donn�s
    // 
    // Armor            : 
    // R�g�n�ration     : R�g�n�re 10 % de la vie toutes les 20 secondes
    // Peau de dragon   : 10 % de resistance aux coups
    // Esquive fant�me  : 10 % de chance de supprimer des d�g�ts
    // 
