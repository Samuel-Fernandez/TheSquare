...
public class PNJMovementAnimation : MonoBehaviour
{
    ...
    // Variable pour garder en m�moire la derni�re direction de mouvement
    ...
    // M�thode pour retourner le sprite horizontalement
    private void FlipSprite(bool flip)
    {
        Vector3 scale = transform.localScale;
        scale.x = flip ? -Mathf.Abs(scale.x) : Mathf.Abs(scale.x); // Inverser seulement la valeur de l'�chelle x
