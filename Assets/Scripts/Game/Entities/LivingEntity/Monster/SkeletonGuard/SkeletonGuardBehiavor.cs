...
public class SkeletonGuardBehavior : MonoBehaviour
{
    ...
    private void Animate()
    {
        ...
        else
        {
            ...
            // Flip uniquement si d�placement significatif sur X
    ...
    IEnumerator DashRoutine()
    {
        ...
        // �TAPE 1 : Pr�mices du dash
        Vector2 dashDirection = (player.position - transform.position).normalized;

        // �TAPE 2 : Chargement du dash (0.9s -> 3 sprites * 0.3s)
        ...
        // �TAPE 3 : Dash initial (1s � 4x vitesse)
        ...
        // D�c�l�ration lin�aire (de 4x vitesse � 0)
        elapsed = 0f;
        while (elapsed < decelDuration)
        {
            float t = 1f - (elapsed / decelDuration); // interpolation invers�e
