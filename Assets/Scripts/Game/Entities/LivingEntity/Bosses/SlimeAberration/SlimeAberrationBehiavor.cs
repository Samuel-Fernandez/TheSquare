...
public class SlimeAberrationBehiavor : MonoBehaviour
{
    ...
    // S�lectionne une attaque al�atoire pour le Slime Aberration
    // en fonction d'une liste de probabilit�s d�finies.
    ...
    // Supprime le boss de la sc�ne
    // D�truit l'UI associ�e (barre de vie) et l'objet du boss lui-m�me.
    ...
    // Coroutine qui attend un d�lai al�atoire, puis choisit et lance une attaque
    // R�p�te ind�finiment tant que le boss est actif
    ...
    {
        // Rayon max dans lequel l'�il peut appara�tre
        float radius = 1f;

        // Position al�atoire dans un cercle autour du transform
    ...
    {
        // Supprimer le collider si pr�sent
    ...
    IEnumerator BounceRoutine()
    {
        ...
        float duration = 1f;        // Dur�e totale du saut
        float elapsed = 0f;
        ...
        while (elapsed < duration)
        {
            ...
            // Courbe sinuso�dale pour un mouvement fluide
        ...
        // S'assure qu'on termine bien � la position de d�part
        ...
        for (int i = 0; i < Random.Range(5, 20); i++)
        {
            ...
            // G�n�ration d'une target al�atoire : 
            ...
            // Vitesse al�atoire entre 5 et 8
