...
public class SoundContainer : MonoBehaviour
{
    ...
    {
        // Trouver le groupe de sons correspondant � l'ID
        ...
        // S�lectionner un clip al�atoire
    ...
    public void PlaySound(string id, int pitchPower)
    {
        ...
        // D�terminer le pitch en fonction du pitchPower
        float pitch = 1f; // Valeur par d�faut
        switch (pitchPower)
        {
            case 1:
        ...
        // Jouer le son avec le pitch d�termin�
