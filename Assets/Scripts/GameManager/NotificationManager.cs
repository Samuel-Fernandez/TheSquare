...
public class NotificationManager : MonoBehaviour
{
    ...
    // Utilis� pour savoir si une instance existe actuellement
    ...
    private IEnumerator AnimateValue(TextMeshProUGUI textComponent, int startValue, int endValue, float duration)
    {
        ...
        textComponent.text = endValue.ToString(); // Assure que la valeur finale est bien affich�e
    }
    ...
    public void ShowPopup(string text)
    {
        ...
        // Trouver le TextMeshPro enfant et mettre � jour le texte
        ...
        // D�truire le popup apr�s 2 secondes
    ...
    {
        // Emp�che une nouvelle bulle si une est d�j� active
        if (activeBubble != null)
        {
            Debug.LogWarning("Une bulle est d�j� active !");
            return null;
        }
