...
public class DungeonManager : MonoBehaviour
{
    ...
    private void Update()
    {
        // Si dans un donjon et pas de donjon ajout�
    ...
    {
        // Recherche du donjon dans la base de donn�es en fonction du titre
    ...
    public void AddKey()
    {
        ...
        {
            // Augmente le nombre de cl�s du donjon
    ...
    public void RemoveKey()
    {
        if (actualDungeon != null)
        {
            ...
            {
                // Diminue le nombre de cl�s du donjon
                actualDungeon.nbKeys--;
