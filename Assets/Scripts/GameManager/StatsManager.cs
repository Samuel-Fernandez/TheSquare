...
public class StatsManager : MonoBehaviour
{
    ...
    {
        // Nettoyer le nom du monstre pour enlever les suffixes ajout�s par Unity
        int index = monsterID.IndexOf(" (");
        if (index > 0)
        {
            monsterID = monsterID.Substring(0, index); // Supprime tout apr�s " ("
        }
        ...
        // Si le monstre n'est pas trouv�, on l'ajoute
