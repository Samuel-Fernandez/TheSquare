...
public class SaveManager : MonoBehaviour
{
    ...
    public void SaveSpecialObjectsOnly()
    {
        ...
        // Mettre � jour uniquement les SpecialObjects
        ...
        // R��crire la sauvegarde compl�te avec les SpecialObjects mis � jour
    ...
    public void SaveDungeonsOnly()
    {
        ...
        // Mettre � jour uniquement les donjons
        existingData.dungeons = DungeonManager.instance.dungeonDB;

        // R��crire la sauvegarde compl�te avec les donjons mis � jour
        string updatedJson = JsonUtility.ToJson(existingData, true);
        File.WriteAllText(saveFilePath, updatedJson);
    ...
    public List<Item> GetSpecialItemsFromSaveItem(List<SaveSpecialItem> saveSpecialItems)
    {
        ...
        foreach (var saveItem in saveSpecialItems)
        {
            // Cr�e une nouvelle instance de SpecialItems pour chaque SaveSpecialItem
...
public struct SaveSpecialItem
{
    ...
    {
        this.name = name;
        this.type = type; // Corrig� : assigne le param�tre 'type' � 'this.type'
        this.nb = nb;     // Assigne le param�tre 'nb' � 'this.nb'
        this.id = id;
    }
...
public class TwoStateContainer
{
    ...
    {
        // Enregistrer les �tats permanents
        ...
        // Supprimer tous les �tats temporaires apr�s la sauvegarde
