...
public class Event : ScriptableObject
{
    ...
    // SPECIAL METHODS
    public string targetObjectName; // Nom de l'objet sur lequel ex�cuter la m�thode
    public string componentType;    // Type du composant (ex: "LifeManager")
    public string methodName;       // Nom de la m�thode (ex: "TakeDamage")
    public string[] parameters;     // Param�tres sous forme de cha�nes (ex: ["4"])
